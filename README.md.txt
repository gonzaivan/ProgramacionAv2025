...
Proyecto final para la materia Programación Avanzada. Este sistema es una aplicación de escritorio en Java diseñada para administrar la asignación de habitaciones y limpieza de un hotel durante los Juegos Olímpicos.
...
Para correr el proyecto, necesitas ejecutar este script en tu gestor de MySQL (phpMyAdmin) para crear la estructura y el usuario administrador:
...
✒️ Autor
Gonzalo Ivan Fernandez - Desarrollo Inicial y Lógica de Negocio